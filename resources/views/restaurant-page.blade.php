 	      	...
 	      	<div class="restaurant-menu-details-wrap">
 	      	  ...
 	      	  <div class="restaurant-menu-label"><i class="icon-food _icon"></i>Menu</div>
 	      		...
 	      		<div class="each-menu-category-wrap">
 	      		  ...
 	      		  <div class="each-category-menu-item "><span class="item-name" data-product-id="4" data-product-title="Chicken Changezjhgghhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhi" data-product-price="160">Chicken Changezi</span><span class="item-price">Rs 200</span><div class="add-to-cart-label">add to cart</div></div>
